...
semphr. h 
\begin{DoxyCode}{0}
\DoxyCodeLine{xSemaphoreGiveRecursive(\ \mbox{\hyperlink{semphr_8h_ad88c6df4a04beedeac782918c8a332f5}{SemaphoreHandle\_t}}\ xMutex\ );}
...
\DoxyCodeLine{\ \ \ \ \ \textcolor{keywordflow}{if}(\ xSemaphoreTakeRecursive(\ xMutex,\ (\ \mbox{\hyperlink{_a_r_mv8_m_2non__secure_2portmacrocommon_8h_a83586323ab175c3dfcbd7f4704e09743}{TickType\_t}}\ )\ 10\ )\ ==\ \mbox{\hyperlink{projdefs_8h_af268cf937960eb029256bd9c4d949fbe}{pdTRUE}}\ )}
\DoxyCodeLine{\ \ \ \ \ \{}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ these\ calls\ sequentially,\ it\ would\ be\ more\ likely\ that\ the\ calls}}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ to\ xSemaphoreGiveRecursive()\ would\ be\ called\ as\ a\ call\ stack}}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ unwound.\ \ This\ is\ just\ for\ demonstrative\ purposes.}}
